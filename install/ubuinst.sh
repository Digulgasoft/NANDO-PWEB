...
exit;
  ...
  echo -e 'by: CONEXAO NET' >/usr/lib/telegram
  msg -bar
...
wget  https://github.com/Digulgasoft/NANDO-PWEB/raw/painel/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget  https://github.com/Digulgasoft/NANDO-PWEB/raw/painel/install/verifatt.sh > /dev/null 2>&1
wget  https://github.com/Digulgasoft/NANDO-PWEB/raw/painel/install/verpweb > /dev/null 2>&1
wget  https://github.com/Digulgasoft/NANDO-PWEB/raw/painel/install/verweb > /dev/null 2>&1
...
wget  https://github.com/Digulgasoft/NANDO-PWEB/raw/painel/install/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "raw.githubusercontent.com/Digulgasoft/NANDO-PWEB/painel/install/chave") &>/dev/null
...
echo -e "PAINELCONEXAO NET" | figlet
echo -e "                              \033[1;31mBy CONEXAO NET\033[1;36m"
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37mCONEXAO NET\033[0m"
echo ""
